...
def main():
    ...
    ply_data_dir = 'F:/数据集/ModelNet10/ModelNet10/ply_data_points'

    # off文件所在路径
    # off_data_dir = '/home/rq/cloud_lesson/ModelNet40/off_data'
    off_data_dir = 'F:/数据集/ModelNet10/ModelNet10/off_data'

    write_ply_points_only_from_off(ply_data_dir, off_data_dir)

if __name__ == '__main__':
    main()
    # filename = 'F:/数据集/ModelNet10/ModelNet10/off_data/bathtub/test/bathtub_0107.off'
    # points, faces = read_off(filename)